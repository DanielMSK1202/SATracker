 ...
 * read from a server-only environment variable (a Supabase Edge Function
 * secret) - it never appears in any response sent to the browser, and this
 * module is never imported by any client-side code.
 */
